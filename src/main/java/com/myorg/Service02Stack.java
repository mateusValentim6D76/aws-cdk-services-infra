    ...
    public Service02Stack(final Construct scope, final String id, final StackProps props, Cluster cluster, SnsTopic productEventsTopic, Table productEventsDynamoDb) {
        ...
        ApplicationLoadBalancedFargateService productServiceConsumer = ApplicationLoadBalancedFargateService
                ...
                .taskImageOptions(ApplicationLoadBalancedTaskImageOptions.builder()
                        ...
                        .image(ContainerImage.fromRegistry("mateusvalentim/aws-mv-product-consumer:1.2.0"))
                        .containerPort(8081)
        ...
        productEventsQueue.grantConsumeMessages(productServiceConsumer.getTaskDefinition().getTaskRole());
        productEventsDynamoDb.grantReadWriteData(productServiceConsumer.getTaskDefinition().getTaskRole());
    }
}
